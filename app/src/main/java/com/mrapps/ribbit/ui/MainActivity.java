...
import com.mrapps.ribbit.adapters.SectionsPagerAdapter;
...
public class MainActivity extends FragmentActivity implements ActionBar.TabListener {
    ...
    protected DialogInterface.OnClickListener mDialogListener =
            new DialogInterface.OnClickListener(){
                ...
                public void onClick(DialogInterface dialog, int which){
                    switch(which) {
                        case 0: //Take picture and set save location
                            Intent takePhotoIntent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
                            mMediaUri = getOutputMediaFileUri(MEDIA_TYPE_IMAGE);
                            if (mMediaUri == null) {
                                //display an error
                                Toast.makeText(MainActivity.this, R.string.error_external_store, Toast.LENGTH_LONG).show();
                            }
                            else {
                ...
                private Uri getOutputMediaFileUri(int mediaType) {
                    // To be safe, you should check that the SDCard(or external storage) is mounted
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < mSectionsPagerAdapter.getCount(); i++) {
            ...
            actionBar.addTab(
                    actionBar.newTab().setIcon(mSectionsPagerAdapter.getIcon(i))
                            .setTabListener(this));
        }
    }
